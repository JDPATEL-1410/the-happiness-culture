...
const MarriageCalculator = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Marriage Planning Calculator</h2>
      ...
      <div className="bg-gray-50 p-6 rounded-lg shadow text-center">
        <h3 className="text-gray-600">Future Marriage Cost</h3>
        <p className="text-2xl font-bold text-success-600 mt-2">₹{futureCost.toLocaleString()}</p>
      </div>
    </div>
  );
};
